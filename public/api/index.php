<?php
$dsn = 'sqlite://C:\Users\bo_ba\Github\Github_vue-cstj\todo\database\db.sqlite';
$clients = [];
...
ArrestDB::Serve('POST', '/(#any)', function ($table)
{
	...
	else if (is_array($_POST) === true)
	{
		...
		else
		{
			...
			$result['success']['id'] = ArrestDB::Query()->lastInsertId();
		}
	}
...
class ArrestDB
{
	...
	public static $allowedMethods = 'GET, POST, OPTIONS, PUT, DELETE';
	...
	public static function cors() {
		...
		} else if (in_array($httpOrigin, self::$allowedOrigins)) {
		...
		if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
			...
			$allowedHeaders = isset($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_HEADERS']) ? $_SERVER['HTTP_ACCESS_CONTROL_REQUEST_HEADERS'] : '';
